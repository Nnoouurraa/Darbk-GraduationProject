...
import 'package:darbk/screens/SignUp_D.dart';

class Login_D extends StatefulWidget {
  const Login_D({super.key});

  @override
  State<Login_D> createState() => _LoginDState();
}

class _LoginDState extends State<Login_D> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (!doc.exists || doc['status'] != 'approved') {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Account not yet approved by admin')),
        );
        return;
      }

      // Approved, navigate to PhysioHomeScreen
      navigateWithAnimation(context,  PhysioHomeScreen());
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: GestureDetector(
                      onTap: () => navigateWithAnimation(context, const SignUp_D()),
                      child: RichText(
                        text: const TextSpan(
